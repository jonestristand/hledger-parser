...
const tests = [
  {
    ...
    Expenses:Food\n`,
    expected: ['DateAtStart', 'Text', 'NEWLINE',
    ...
    expected: ['DateAtStart', 'TxnStatusIndicator', { 'ParenValue': 'a' }, 'Text', 'PIPE', 'Text', 'SemicolonComment', 'InlineCommentText', 'InlineCommentTagName', 'InlineCommentTagColon', 'InlineCommentTagValue', 'InlineCommentTagComma', 'NEWLINE',
